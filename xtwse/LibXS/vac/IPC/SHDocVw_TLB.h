...
// File generated on 2009/11/10 ¤W¤È 10:37:13 from Type Library described below.
...
extern const GUID CLSID_InternetExplorerMedium;
...
extern const GUID IID_IShellUIHelper3;
...
typedef TComInterface<InternetExplorerMedium, &IID_IWebBrowser2> InternetExplorerMediumPtr;
...
typedef IShellUIHelper3 ShellUIHelper;
typedef TComInterface<ShellUIHelper, &IID_IShellUIHelper3> ShellUIHelperPtr;
...
interface DWebBrowserEvents2 : public TDispWrapper<IDispatch>
{
  ...
  void __fastcall NewProcess(long lCauseFlag/*[in]*/, LPDISPATCH pWB2/*[in]*/, 
                             TOLEBOOL* Cancel/*[in,out]*/)
  {
  ...
  void __fastcall ThirdPartyUrlBlocked(TVariant* URL/*[in]*/, unsigned_long dwCount/*[in]*/)
  {
  ...
  void __fastcall RedirectXDomainBlocked(LPDISPATCH pDisp/*[in]*/, TVariant* StartURL/*[in]*/, 
                                         TVariant* RedirectURL/*[in]*/, TVariant* Frame/*[in]*/, 
...
// *********************************************************************//
interface IShellUIHelper3 : public IShellUIHelper2
{
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE InPrivateFilteringEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/) = 0; // [37]
  virtual HRESULT STDMETHODCALLTYPE AddToFavoritesBar(BSTR URL/*[in]*/, BSTR Title/*[in]*/, 
                                                      TVariant* Type/*[in,opt]*/= TNoParam()) = 0; // [32]
  virtual HRESULT STDMETHODCALLTYPE BuildNewTabPage(void) = 0; // [33]
  virtual HRESULT STDMETHODCALLTYPE SetRecentlyClosedVisible(TOLEBOOL fVisible/*[in]*/) = 0; // [34]
  virtual HRESULT STDMETHODCALLTYPE SetActivitiesVisible(TOLEBOOL fVisible/*[in]*/) = 0; // [35]
  virtual HRESULT STDMETHODCALLTYPE ContentDiscoveryReset(void) = 0; // [36]
  virtual HRESULT STDMETHODCALLTYPE IsSuggestedSitesEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/) = 0; // [38]
  virtual HRESULT STDMETHODCALLTYPE EnableSuggestedSites(TOLEBOOL fEnable/*[in]*/) = 0; // [39]
  ...
  TOLEBOOL __fastcall InPrivateFilteringEnabled(void)
  {
    TOLEBOOL pfEnabled;
    OLECHECK(this->InPrivateFilteringEnabled((TOLEBOOL*)&pfEnabled));
    return pfEnabled;
  }

  TOLEBOOL __fastcall IsSuggestedSitesEnabled(void)
  {
    TOLEBOOL pfEnabled;
    OLECHECK(this->IsSuggestedSitesEnabled((TOLEBOOL*)&pfEnabled));
    return pfEnabled;
  }
...
public:
  ...
  void            __fastcall NewProcess(long lCauseFlag/*[in]*/, LPDISPATCH pWB2/*[in]*/, 
                                        TOLEBOOL* Cancel/*[in,out]*/);
  void            __fastcall ThirdPartyUrlBlocked(TVariant* URL/*[in]*/, 
                                                  unsigned_long dwCount/*[in]*/);
  void            __fastcall RedirectXDomainBlocked(LPDISPATCH pDisp/*[in]*/, 
...
public:
  ...
  HRESULT         __fastcall IsServiceInstalled(BSTR URL/*[in]*/, BSTR Verb/*[in]*/, 
                                                unsigned_long* pdwResult/*[out,retval]*/);
  unsigned_long   __fastcall IsServiceInstalled(BSTR URL/*[in]*/, BSTR Verb/*[in]*/);
  HRESULT         __fastcall InPrivateFilteringEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/);
  TOLEBOOL        __fastcall InPrivateFilteringEnabled(void);
  HRESULT         __fastcall AddToFavoritesBar(BSTR URL/*[in]*/, BSTR Title/*[in]*/, 
                                               TVariant* Type/*[in,opt]*/= TNoParam());
  HRESULT         __fastcall BuildNewTabPage(void);
  HRESULT         __fastcall SetRecentlyClosedVisible(TOLEBOOL fVisible/*[in]*/);
  HRESULT         __fastcall SetActivitiesVisible(TOLEBOOL fVisible/*[in]*/);
  HRESULT         __fastcall ContentDiscoveryReset(void);
  HRESULT         __fastcall IsSuggestedSitesEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/);
  TOLEBOOL        __fastcall IsSuggestedSitesEnabled(void);
  HRESULT         __fastcall EnableSuggestedSites(TOLEBOOL fEnable/*[in]*/);
...
public:
  ...
  HRESULT         __fastcall AddToFavoritesBar(BSTR URL/*[in]*/, BSTR Title/*[in]*/, 
                                               TVariant* Type/*[in,opt]*/= TNoParam());
  HRESULT         __fastcall BuildNewTabPage();
  HRESULT         __fastcall SetRecentlyClosedVisible(TOLEBOOL fVisible/*[in]*/);
  HRESULT         __fastcall SetActivitiesVisible(TOLEBOOL fVisible/*[in]*/);
  HRESULT         __fastcall ContentDiscoveryReset();
  HRESULT         __fastcall IsSuggestedSitesEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/);
  TOLEBOOL        __fastcall IsSuggestedSitesEnabled(void);
  HRESULT         __fastcall EnableSuggestedSites(TOLEBOOL fEnable/*[in]*/);
  HRESULT         __fastcall NavigateToSuggestedSites(BSTR bstrRelativeUrl/*[in]*/);
  HRESULT         __fastcall ShowTabsHelp();
  HRESULT         __fastcall ShowInPrivateHelp();
  HRESULT         __fastcall AddSearchProvider(BSTR URL/*[in]*/);
  HRESULT         __fastcall RunOnceShown();
  HRESULT         __fastcall SkipRunOnce();
  HRESULT         __fastcall CustomizeSettings(TOLEBOOL fSQM/*[in]*/, TOLEBOOL fPhishing/*[in]*/, 
...
template <class T> void __fastcall
DWebBrowserEvents2DispT<T>::ThirdPartyUrlBlocked(TVariant* URL/*[in]*/, 
                                                 unsigned_long dwCount/*[in]*/)
{
  _TDispID _dispid(/* ThirdPartyUrlBlocked */ DISPID(285));
  TAutoArgs<2> _args;
...
template <class T> HRESULT __fastcall
TCOMIShellUIHelper3T<T>::InPrivateFilteringEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIShellUIHelper3T<T>::SetRecentlyClosedVisible(TOLEBOOL fVisible/*[in]*/)
{
  return (*this)->SetRecentlyClosedVisible(fVisible);
}

template <class T> HRESULT __fastcall
TCOMIShellUIHelper3T<T>::SetActivitiesVisible(TOLEBOOL fVisible/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIShellUIHelper3T<T>::IsSuggestedSitesEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIShellUIHelper3T<T>::EnableSuggestedSites(TOLEBOOL fEnable/*[in]*/)
{
...
{
  static _TDispID _dispid(*this, OLETEXT("AddService"), DISPID(30));
  TAutoArgs<1> _args;
  _args[1] = URL /*[VT_BSTR:0]*/;
  return OleFunction(_dispid, _args);
}
...
IShellUIHelper3DispT<T>::IsServiceInstalled(BSTR URL/*[in]*/, BSTR Verb/*[in]*/, 
                                            unsigned_long* pdwResult/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("IsServiceInstalled"), DISPID(31));
  TAutoArgs<2> _args;
  _args[1] = URL /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::InPrivateFilteringEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("InPrivateFilteringEnabled"), DISPID(37));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(pfEnabled /*[VT_BOOL:1]*/, _args, OleFunction(_dispid, _args));
}
...
{
  TOLEBOOL pfEnabled;
  this->InPrivateFilteringEnabled((TOLEBOOL*)&pfEnabled);
  return pfEnabled;
}
...
IShellUIHelper3DispT<T>::AddToFavoritesBar(BSTR URL/*[in]*/, BSTR Title/*[in]*/, 
                                           TVariant* Type/*[in,opt]*/)
{
  static _TDispID _dispid(*this, OLETEXT("AddToFavoritesBar"), DISPID(32));
  TAutoArgs<3> _args;
  _args[1] = URL /*[VT_BSTR:0]*/;
...
{
  static _TDispID _dispid(*this, OLETEXT("BuildNewTabPage"), DISPID(33));
  return OleFunction(_dispid);
}

template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::SetRecentlyClosedVisible(TOLEBOOL fVisible/*[in]*/)
{
  static _TDispID _dispid(*this, OLETEXT("SetRecentlyClosedVisible"), DISPID(34));
  TAutoArgs<1> _args;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::SetActivitiesVisible(TOLEBOOL fVisible/*[in]*/)
{
  static _TDispID _dispid(*this, OLETEXT("SetActivitiesVisible"), DISPID(35));
  TAutoArgs<1> _args;
  _args[1] = fVisible /*[VT_BOOL:0]*/;
  return OleFunction(_dispid, _args);
}
...
{
  static _TDispID _dispid(*this, OLETEXT("ContentDiscoveryReset"), DISPID(36));
  return OleFunction(_dispid);
}

template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::IsSuggestedSitesEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("IsSuggestedSitesEnabled"), DISPID(38));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(pfEnabled /*[VT_BOOL:1]*/, _args, OleFunction(_dispid, _args));
}
...
{
  TOLEBOOL pfEnabled;
  this->IsSuggestedSitesEnabled((TOLEBOOL*)&pfEnabled);
  return pfEnabled;
}

template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::EnableSuggestedSites(TOLEBOOL fEnable/*[in]*/)
{
  static _TDispID _dispid(*this, OLETEXT("EnableSuggestedSites"), DISPID(39));
  TAutoArgs<1> _args;
...
{
  static _TDispID _dispid(*this, OLETEXT("NavigateToSuggestedSites"), DISPID(40));
  TAutoArgs<1> _args;
...
{
  static _TDispID _dispid(*this, OLETEXT("ShowTabsHelp"), DISPID(41));
  return OleFunction(_dispid);
}
...
{
  static _TDispID _dispid(*this, OLETEXT("ShowInPrivateHelp"), DISPID(42));
  return OleFunction(_dispid);
}
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::CustomizeSettings(TOLEBOOL fSQM/*[in]*/, TOLEBOOL fPhishing/*[in]*/, 
                                           BSTR bstrLocale/*[in]*/)
{
  static _TDispID _dispid(*this, OLETEXT("CustomizeSettings"), DISPID(17));
  TAutoArgs<3> _args;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::SqmEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("SqmEnabled"), DISPID(18));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(pfEnabled /*[VT_BOOL:1]*/, _args, OleFunction(_dispid, _args));
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::PhishingEnabled(TOLEBOOL* pfEnabled/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("PhishingEnabled"), DISPID(19));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(pfEnabled /*[VT_BOOL:1]*/, _args, OleFunction(_dispid, _args));
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::CustomizeClearType(TOLEBOOL fSet/*[in]*/)
{
  static _TDispID _dispid(*this, OLETEXT("CustomizeClearType"), DISPID(23));
  TAutoArgs<1> _args;
  _args[1] = fSet /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::IsSearchMigrated(TOLEBOOL* pfMigrated/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("IsSearchMigrated"), DISPID(25));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(pfMigrated /*[VT_BOOL:1]*/, _args, OleFunction(_dispid, _args));
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::RunOnceRequiredSettingsComplete(TOLEBOOL fComplete/*[in]*/)
{
  static _TDispID _dispid(*this, OLETEXT("RunOnceRequiredSettingsComplete"), DISPID(27));
  TAutoArgs<1> _args;
  _args[1] = fComplete /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::RunOnceHasShown(TOLEBOOL* pfShown/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("RunOnceHasShown"), DISPID(28));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(pfShown /*[VT_BOOL:1]*/, _args, OleFunction(_dispid, _args));
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::AddFavorite(BSTR URL/*[in]*/, TVariant* Title/*[in,opt]*/)
{
  static _TDispID _dispid(*this, OLETEXT("AddFavorite"), DISPID(4));
  TAutoArgs<2> _args;
  _args[1] = URL /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::IsSubscribed(BSTR URL/*[in]*/, TOLEBOOL* pBool/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("IsSubscribed"), DISPID(7));
  TAutoArgs<1> _args;
  _args[1] = URL /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::ImportExportFavorites(TOLEBOOL fImport/*[in]*/, BSTR strImpExpPath/*[in]*/)
{
  static _TDispID _dispid(*this, OLETEXT("ImportExportFavorites"), DISPID(9));
  TAutoArgs<2> _args;
  _args[1] = fImport /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::AutoCompleteSaveForm(TVariant* Form/*[in,opt]*/)
{
  static _TDispID _dispid(*this, OLETEXT("AutoCompleteSaveForm"), DISPID(10));
  TAutoArgs<1> _args;
  _args[1] = Form /*[VT_VARIANT:1]*/;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::AutoCompleteAttach(TVariant* Reserved/*[in,opt]*/)
{
  static _TDispID _dispid(*this, OLETEXT("AutoCompleteAttach"), DISPID(12));
  TAutoArgs<1> _args;
  _args[1] = Reserved /*[VT_VARIANT:1]*/;
...
template <class T> HRESULT __fastcall
IShellUIHelper3DispT<T>::ShowBrowserUI(BSTR bstrName/*[in]*/, TVariant* pvarIn/*[in]*/, 
                                       TVariant* pvarOut/*[out,retval]*/)
{
  static _TDispID _dispid(*this, OLETEXT("ShowBrowserUI"), DISPID(13));
  TAutoArgs<2> _args;
...
// *********************************************************************//
typedef TCoClassCreatorT<TCOMIShellUIHelper3, IShellUIHelper3, &CLSID_ShellUIHelper, &IID_IShellUIHelper3> CoShellUIHelper;
...
public:
  ...
  void            Fire_NewProcess(long lCauseFlag, LPDISPATCH pWB2, TOLEBOOL* Cancel);
  void            Fire_ThirdPartyUrlBlocked(TVariant* URL, unsigned_long dwCount);
  void            Fire_RedirectXDomainBlocked(LPDISPATCH pDisp, TVariant* StartURL, 
                                              TVariant* RedirectURL, TVariant* Frame, 
                                              TVariant* StatusCode);
protected:
...
template <class T> void
TEvents_WebBrowser<T>::Fire_NewProcess(long lCauseFlag, LPDISPATCH pWB2, TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
  while (pp < m_vec.end())
  {
    ...
    {
      m_EventIntfObj.Attach(*pp);
      m_EventIntfObj.NewProcess(lCauseFlag, pWB2, Cancel);
      m_EventIntfObj.Attach(0);
    }
    pp++;
  }
...
template <class T> void
TEvents_WebBrowser<T>::Fire_ThirdPartyUrlBlocked(TVariant* URL, unsigned_long dwCount)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
  while (pp < m_vec.end())
  {
    ...
    {
      m_EventIntfObj.Attach(*pp);
      m_EventIntfObj.ThirdPartyUrlBlocked(URL, dwCount);
      m_EventIntfObj.Attach(0);
    }
    pp++;
  }
...
template <class T> void
TEvents_WebBrowser<T>::Fire_RedirectXDomainBlocked(LPDISPATCH pDisp, TVariant* StartURL, 
                                                   TVariant* RedirectURL, TVariant* Frame, 
                                                   TVariant* StatusCode)
{
  T * pT = (T*)this;
  ...
  while (pp < m_vec.end())
  {
    ...
    {
      m_EventIntfObj.Attach(*pp);
      m_EventIntfObj.RedirectXDomainBlocked(pDisp, StartURL, RedirectURL, Frame, StatusCode);
      m_EventIntfObj.Attach(0);
    }
    pp++;
  }
...
template <class T> void
TEvents_InternetExplorer<T>::Fire_NewProcess(long lCauseFlag, LPDISPATCH pWB2, TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorer<T>::Fire_ThirdPartyUrlBlocked(TVariant* URL, unsigned_long dwCount)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorer<T>::Fire_RedirectXDomainBlocked(LPDISPATCH pDisp, TVariant* StartURL, 
                                                         TVariant* RedirectURL, TVariant* Frame, 
                                                         TVariant* StatusCode)
{
  T * pT = (T*)this;
...
// *********************************************************************//
template <class T>
class TEvents_InternetExplorerMedium : public IConnectionPointImpl<T,
                                                 &DIID_DWebBrowserEvents2,
                                                 CComUnkArray<CONNECTIONPOINT_ARRAY_SIZE> >
{
public:
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_StatusTextChange(BSTR Text)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_ProgressChange(long Progress, long ProgressMax)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_CommandStateChange(long Command, TOLEBOOL Enable)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_DownloadBegin(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_DownloadComplete(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_TitleChange(BSTR Text)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_PropertyChange(BSTR szProperty)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_BeforeNavigate2(LPDISPATCH pDisp, TVariant* URL, 
                                                        TVariant* Flags, TVariant* TargetFrameName, 
                                                        TVariant* PostData, TVariant* Headers, 
                                                        TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_NewWindow2(LPDISPATCH* ppDisp, TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_NavigateComplete2(LPDISPATCH pDisp, TVariant* URL)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_DocumentComplete(LPDISPATCH pDisp, TVariant* URL)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_OnQuit(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_OnVisible(TOLEBOOL Visible)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_OnToolBar(TOLEBOOL ToolBar)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_OnMenuBar(TOLEBOOL MenuBar)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_OnStatusBar(TOLEBOOL StatusBar)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_OnFullScreen(TOLEBOOL FullScreen)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_OnTheaterMode(TOLEBOOL TheaterMode)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_WindowSetResizable(TOLEBOOL Resizable)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_WindowSetLeft(long Left)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_WindowSetTop(long Top)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_WindowSetWidth(long Width)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_WindowSetHeight(long Height)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_WindowClosing(TOLEBOOL IsChildWindow, TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_ClientToHostWindow(long* CX, long* CY)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_SetSecureLockIcon(long SecureLockIcon)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_FileDownload(TOLEBOOL ActiveDocument, TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_NavigateError(LPDISPATCH pDisp, TVariant* URL, 
                                                      TVariant* Frame, TVariant* StatusCode, 
                                                      TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_PrintTemplateInstantiation(LPDISPATCH pDisp)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_PrintTemplateTeardown(LPDISPATCH pDisp)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_UpdatePageStatus(LPDISPATCH pDisp, TVariant* nPage, 
                                                         TVariant* fDone)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_PrivacyImpactedStateChange(TOLEBOOL bImpacted)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_NewWindow3(LPDISPATCH* ppDisp, TOLEBOOL* Cancel, 
                                                   unsigned_long dwFlags, BSTR bstrUrlContext, 
                                                   BSTR bstrUrl)
{
  T * pT = (T*)this;
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_SetPhishingFilterStatus(long PhishingFilterStatus)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_WindowStateChanged(unsigned_long dwWindowStateFlags, 
                                                           unsigned_long dwValidFlagsMask)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_NewProcess(long lCauseFlag, LPDISPATCH pWB2, 
                                                   TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_ThirdPartyUrlBlocked(TVariant* URL, unsigned_long dwCount)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_InternetExplorerMedium<T>::Fire_RedirectXDomainBlocked(LPDISPATCH pDisp, TVariant* StartURL, 
                                                               TVariant* RedirectURL, 
                                                               TVariant* Frame, TVariant* StatusCode)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> void
TEvents_ShellBrowserWindow<T>::Fire_NewProcess(long lCauseFlag, LPDISPATCH pWB2, TOLEBOOL* Cancel)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_ShellBrowserWindow<T>::Fire_ThirdPartyUrlBlocked(TVariant* URL, unsigned_long dwCount)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_ShellBrowserWindow<T>::Fire_RedirectXDomainBlocked(LPDISPATCH pDisp, TVariant* StartURL, 
                                                           TVariant* RedirectURL, TVariant* Frame, 
                                                           TVariant* StatusCode)
{
  T * pT = (T*)this;
