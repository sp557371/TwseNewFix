...
protected:
    ...
    virtual K_mf(bool)  OnRptPkt     (TbxRptSes&, const TControlHead&) = 0;
public:
    virtual K_mf(int)   GetPacketSize(TbxSesBase&, const TbxData&);
    virtual K_mf(int)   BeforeAPacket(TbxSesBase&, const TbxData&);
    virtual K_mf(bool)  DoRptReq     (TbxRptSes&, const TBxMsg, const TControlHead&) = 0;
};
/////////////////////////////////////////////////////////////////////////////
...
protected:
    virtual K_mf(bool)  OnRptPkt     (TbxRptSes&, const TControlHead&);
public:
    virtual K_mf(bool)  DoRptReq     (TbxRptSes&, const TBxMsg, const TControlHead&);
};
/////////////////////////////////////////////////////////////////////////////
...
public:
    // R3 只有被動端, 不需要執行要求
    virtual K_mf(bool)  DoRptReq     (TbxRptSes&, const TBxMsg, const TControlHead&) { return true; }
};
/////////////////////////////////////////////////////////////////////////////
