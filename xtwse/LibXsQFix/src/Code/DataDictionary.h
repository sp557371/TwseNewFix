...
public:
  ...
  // storage functions
  K_mf(void) setVersion( const std::string& beginString )
  {
  ...
  {
    #if defined(__BORLANDC__)
    MsgTypes::const_iterator iter = m_messages.find(msgType);
    return (iter != m_messages.end());
    #else
  ...
  bool isMsgField( const std::string& msgType, int field ) const
  {
    ...
    #if defined(__BORLANDC__)
    MsgFields::const_iterator iter = i->second.find(field);
    return (iter != i->second.end());
    #else
  ...
  bool isFieldValue( int field, const std::string& value ) const
  {
    ...
    {
      #if defined(__BORLANDC__)
      Values::const_iterator iter = i->second.find(value);
      return (iter != i->second.end());
      #else
    ...
    do
    {
      ...
      #if defined(__BORLANDC__)
      Values::const_iterator iter = i->second.find( singleValue );
